...
namespace gf {
    ...
    bool OpenGL_Context::init(BaseWindow *window) {
        ...
        glfwSetCursorPosCallback(glWindow, onCursorPosCallback);
    ...
    void OpenGL_Context::preRender() {
        ImVec2 model_viewport = mWindow->getSceneView()->getSize();
        glViewport(0, 0, model_viewport.x, model_viewport.y);
