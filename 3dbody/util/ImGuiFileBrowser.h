...
#ifndef INC_3DBODY_3DBODY_UTIL_IMGUI_FILE_BROWER_H_
#define INC_3DBODY_3DBODY_UTIL_IMGUI_FILE_BROWER_H_
...
inline void ImGui::FileBrowser::Display()
{
  ...
  {
    ::ImGui::SameLine();
    if(::ImGui::SmallButton(newFolderLabel_))
    {
...
#endif //INC_3DBODY_3DBODY_UTIL_IMGUI_FILE_BROWER_H_
