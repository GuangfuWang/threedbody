...
#include "spdlog/spdlog/common.h"
#include "spdlog/spdlog/details/registry.h"
#include "spdlog/spdlog/logger.h"
#include "spdlog/spdlog/version.h"
#include "spdlog/spdlog/details/synchronous_factory.h"
...
#    define SPDLOG_LOGGER_TRACE(logger, ...) SPDLOG_LOGGER_CALL(logger, spdlog_::level::trace, __VA_ARGS__)
#    define SPDLOG_TRACE(...) SPDLOG_LOGGER_TRACE(spdlog_::default_logger_raw(), __VA_ARGS__)
#else
...
#    define SPDLOG_LOGGER_DEBUG(logger, ...) SPDLOG_LOGGER_CALL(logger, spdlog_::level::debug, __VA_ARGS__)
#    define SPDLOG_DEBUG(...) SPDLOG_LOGGER_DEBUG(spdlog_::default_logger_raw(), __VA_ARGS__)
#else
